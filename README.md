...
Find it on [Greasy Fork](https://greasyfork.org/en/scripts/427213-hn-blacklist), or copy and paste it right from [hn-blacklist.js](https://github.com/booleandilemma/hn-blacklist/blob/master/hn-blacklist.js) in this repository.
